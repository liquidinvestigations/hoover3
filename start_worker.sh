...
(
    export HOOVER3_WORKER_TEMP_DISK_BIG=.worker_temp/host_big
    export HOOVER3_WORKER_TEMP_RAMDISK_SMALL=.worker_temp/host_small
    mkdir -p $HOOVER3_WORKER_TEMP_DISK_BIG
    mkdir -p $HOOVER3_WORKER_TEMP_RAMDISK_SMALL
