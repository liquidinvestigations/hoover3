...
/// QueryFacetOneOf2U32 : Range segment definition for numerical facet field values of type u32
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct QueryFacetOneOf2U32 {
    /// field name
    #[serde(rename = "field")]
    pub field: String,
...
impl QueryFacetOneOf2U32 {
    /// Range segment definition for numerical facet field values of type u32
    pub fn new(field: String, range_type: models::RangeType, ranges: Vec<Vec<serde_json::Value>>) -> QueryFacetOneOf2U32 {
        QueryFacetOneOf2U32 {
            field,
            range_type,
            ranges,
