...
/// QueryFacetOneOf6I32 : Range segment definition for numerical facet field values of type i32
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct QueryFacetOneOf6I32 {
    /// field name
    #[serde(rename = "field")]
    pub field: String,
...
impl QueryFacetOneOf6I32 {
    /// Range segment definition for numerical facet field values of type i32
    pub fn new(field: String, range_type: models::RangeType, ranges: Vec<Vec<serde_json::Value>>) -> QueryFacetOneOf6I32 {
        QueryFacetOneOf6I32 {
            field,
            range_type,
            ranges,
