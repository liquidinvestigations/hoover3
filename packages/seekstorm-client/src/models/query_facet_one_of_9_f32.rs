...
/// QueryFacetOneOf9F32 : Range segment definition for numerical facet field values of type f32
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct QueryFacetOneOf9F32 {
    /// field name
    #[serde(rename = "field")]
    pub field: String,
...
impl QueryFacetOneOf9F32 {
    /// Range segment definition for numerical facet field values of type f32
    pub fn new(field: String, range_type: models::RangeType, ranges: Vec<Vec<serde_json::Value>>) -> QueryFacetOneOf9F32 {
        QueryFacetOneOf9F32 {
            field,
            range_type,
            ranges,
