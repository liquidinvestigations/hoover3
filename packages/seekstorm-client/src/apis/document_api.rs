...
pub async fn delete_document_by_object_api(configuration: &configuration::Configuration, apikey: &str, index_id: i64, search_request_object: models::SearchRequestObject) -> Result<i32, Error<DeleteDocumentByObjectApiError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_apikey = apikey;
    let p_index_id = index_id;
    let p_search_request_object = search_request_object;

    let uri_str = format!("{}/api/v1/index/{index_id}/doc", configuration.base_path, index_id=p_index_id);
...
pub async fn delete_document_by_parameter_api(configuration: &configuration::Configuration, apikey: &str, index_id: i64, document_id: i64) -> Result<i32, Error<DeleteDocumentByParameterApiError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_apikey = apikey;
    let p_index_id = index_id;
    let p_document_id = document_id;

    let uri_str = format!("{}/api/v1/index/{index_id}/doc/{document_id}", configuration.base_path, index_id=p_index_id, document_id=p_document_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn get_document_api(configuration: &configuration::Configuration, apikey: &str, index_id: i64, document_id: i64, get_document_request: models::GetDocumentRequest) -> Result<std::collections::HashMap<String, serde_json::Value>, Error<GetDocumentApiError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_apikey = apikey;
    let p_index_id = index_id;
    let p_document_id = document_id;
...
pub async fn index_document_api(configuration: &configuration::Configuration, apikey: &str, index_id: i64, request_body: std::collections::HashMap<String, serde_json::Value>) -> Result<i32, Error<IndexDocumentApiError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_apikey = apikey;
    let p_index_id = index_id;
...
pub async fn update_document_api(configuration: &configuration::Configuration, apikey: &str, index_id: i64, request_body: Vec<serde_json::Value>) -> Result<i32, Error<UpdateDocumentApiError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_apikey = apikey;
    let p_index_id = index_id;
    let p_request_body = request_body;
