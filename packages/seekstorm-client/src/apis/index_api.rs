...
pub async fn commit_index_api(configuration: &configuration::Configuration, apikey: &str, index_id: i64) -> Result<i64, Error<CommitIndexApiError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_apikey = apikey;
    let p_index_id = index_id;

    let uri_str = format!("{}/api/v1/index/{index_id}", configuration.base_path, index_id=p_index_id);
...
pub async fn create_index_api(configuration: &configuration::Configuration, apikey: &str, create_index_api_request: models::CreateIndexApiRequest) -> Result<i64, Error<CreateIndexApiError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_apikey = apikey;
...
pub async fn delete_index_api(configuration: &configuration::Configuration, apikey: &str, index_id: i64) -> Result<i64, Error<DeleteIndexApiError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_apikey = apikey;
    let p_index_id = index_id;
...
pub async fn get_index_info_api(configuration: &configuration::Configuration, apikey: &str, index_id: i64) -> Result<models::IndexResponseObject, Error<GetIndexInfoApiError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_apikey = apikey;
    let p_index_id = index_id;
